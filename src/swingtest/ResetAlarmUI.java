...
public class ResetAlarmUI extends JDialog {
	...
	final ImageIcon icon_disconnect = new ImageIcon(
			"resource//green_disconnect.png");
	private JPanel panelConnect;
	private JLabel lab_connect;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ResetAlarmUI frame = new ResetAlarmUI(null);
    ...
    public ResetAlarmUI(Frame owner) {
        super(owner, true);
        init();
    }
	/**
	...
	private void handleContent() {
		...
		comboBox.setBounds(178, 12, 93, 29);
		panelConnect.add(comboBox);
	...
	private void disconnect() {
		...
		panelConnect.remove(lab_connect);
